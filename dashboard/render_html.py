...
/* Behind: the gold rim, spanning the band's whole outer height. In front:
   the maroon, spanning its content height exactly — 21+21 against the band's
   42px, starting at the padding edge — so the gold left showing is the same
   2px the band's own border is, and the two maroons meet flush instead of
   stepping 1px at the join.
   ...
   holding it at 2px along the slope would put a 3px step back at the join.
   The join is the part the eye lands on, so that is the one that is kept
   honest. Both sit to the left of the band, hence the negative placement. */
...
a.ribbon .tail { position:absolute; left:-17px; top:0;
                 ...
                 border-top:21px solid #7a1520;
                 border-bottom:21px solid #7a1520; }
